...
@NativeImageHint(trigger = RepositoryRestMvcAutoConfiguration.class, typeInfos = {
		@TypeInfo(types = {
				...
				org.springframework.data.web.PagedResourcesAssembler.class,

				HalMediaTypeConfiguration.class,
				org.springframework.stereotype.Controller.class,


				SpringBootRepositoryRestConfigurer.class,
...
//
						...
						"org.springframework.hateoas.config.RestTemplateHateoasConfiguration.HypermediaRestTemplateBeanPostProcessor",
						"org.springframework.data.rest.core.config.RepositoryRestConfiguration",
//
