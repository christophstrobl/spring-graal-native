...
@NativeHint(trigger=Hikari.class, types = {
	...
	@TypeHint(types = HikariConfig.class, typeNames = { "com.zaxxer.hikari.HikariConfigMXBean", "com.zaxxer.hikari.pool.HikariProxyConnection" } , access = AccessBits.FULL_REFLECTION)})
